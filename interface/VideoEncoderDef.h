...
struct VideoEncRawBuffer{
    ...
    VideoEncRawBuffer():data(0), size(0), bufAvailable(false), timeStamp(0)
    {}
};
...
struct VideoParamsUpstreamBuffer : VideoParamConfigSet {
    ...
    VideoParamsUpstreamBuffer()
        :VideoParamConfigSet(VideoParamsTypeUpSteamBuffer, sizeof(VideoParamsUpstreamBuffer))
...
struct VideoParamsUsrptrBuffer : VideoParamConfigSet {
    ...
    VideoParamsUsrptrBuffer()
        : VideoParamConfigSet(VideoParamsTypeUsrptrBuffer, sizeof(VideoParamsUsrptrBuffer))
...
struct VideoParamsHRD : VideoParamConfigSet {
    ...
    VideoParamsHRD(): VideoParamConfigSet(VideoParamsTypeHRD, sizeof(VideoParamsHRD))
...
struct VideoConfigFrameRate : VideoParamConfigSet {
    ...
    VideoConfigFrameRate()
        : VideoParamConfigSet(VideoConfigTypeFrameRate, sizeof(VideoConfigFrameRate))
        , frameRate(){
    }
...
struct VideoConfigBitRate : VideoParamConfigSet {
    ...
    VideoConfigBitRate()
        :VideoParamConfigSet(VideoConfigTypeBitRate, sizeof(VideoConfigBitRate))
        , rcParams(){
    }
...
struct VideoConfigAVCIntraPeriod : VideoParamConfigSet {
    ...
    VideoConfigAVCIntraPeriod()
        : VideoParamConfigSet(VideoConfigTypeAVCIntraPeriod, sizeof(VideoConfigAVCIntraPeriod))
...
struct VideoConfigNALSize : VideoParamConfigSet {
    ...
    VideoConfigNALSize(): VideoParamConfigSet(VideoConfigTypeNALSize, sizeof(VideoConfigNALSize))
        , maxSliceSize(1){
    }
...
struct VideoConfigResoltuion : VideoParamConfigSet {
    ...
    VideoConfigResoltuion()
        :VideoParamConfigSet(VideoConfigTypeResolution, sizeof(VideoConfigResoltuion))
        , resolution(){}
