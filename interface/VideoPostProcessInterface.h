...
class IVideoPostProcess {
  public:
    ...
    virtual YamiStatus getParameters(VideoParamConfigType type, void* videoEncParams) = 0;
    virtual YamiStatus setParameters(VideoParamConfigType type, void* videoEncParams) = 0;
};
}
